...
class BundlrTransaction extends arbundles_1.DataItem {
    constructor(data, bundlr, opts) {
        var _a;
        super((opts === null || opts === void 0 ? void 0 : opts.dataIsRawTransaction) === true ? Buffer.from(data) : (0, arbundles_1.createData)(data, bundlr.currencyConfig.getSigner(), {
    ...
    static fromRaw(rawTransaction, bundlrInstance) {
