...
class SolanaConfig extends currency_1.default {
    ...
    async getCurrentHeight() {
        var _a;
        return new bignumber_js_1.default((_a = (await (await this.getProvider()).getEpochInfo()).blockHeight) !== null && _a !== void 0 ? _a : 0);
    }
    ...
    async getPublicKey() {
        if (!this.wallet.publicKey)
            throw new Error(`Wallet.publicKet is undefined`);
